...
class BoardBlock(XBlock):
    ...
    def student_view(self, context=None):
        """
        Create primary view of the BoardBlock, shown to students when viewing courses.
        """
        if context:
            pass  # TO-DO: do something based on the context.
        html = self.resource_string("html/boardblock.html")
        frag = Fragment(html.format(self=self))
        frag.add_css(self.resource_string("css/boardblock.css"))
        ...
        frag.add_javascript(self.resource_string("js/src/boardblock.js"))
        frag.initialize_js('BoardBlock')
        return frag
