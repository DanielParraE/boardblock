#!/usr/bin/env python
"""
Package metadata for boardblock.
"""
import os
import re
import sys
...
VERSION = get_version('boardblock', '__init__.py')
...
setup(
    ...
    author='Daniel',
    author_email='',
    url='https://github.com/DanielParraE/boardblock',
    packages=find_packages(
        include=['boardblock', 'boardblock.*'],
        exclude=["*tests"],
    ),
    ...
    package_data=package_data("boardblock", ["static", "public"]),
