...
"""
boardblock documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'boardblock',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/DanielParraE/boardblock",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'boardblock'),
                os.path.join(root_path, 'boardblock/migrations')])
